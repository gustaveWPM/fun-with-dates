...
var _BrowserWindow_instances, _a, _BrowserWindow_browserFrame, _BrowserWindow_innerWidth, _BrowserWindow_innerHeight, _BrowserWindow_outerWidth, _BrowserWindow_outerHeight, _BrowserWindow_devicePixelRatio, _BrowserWindow_bindToThisScope, _b, _c, _d;
...
class BrowserWindow extends EventTarget_js_1.default {
     ...
     * Setup of VM context.
     */
    [(_BrowserWindow_browserFrame = new WeakMap(), _BrowserWindow_innerWidth = new WeakMap(), _BrowserWindow_innerHeight = new WeakMap(), _BrowserWindow_outerWidth = new WeakMap(), _BrowserWindow_outerHeight = new WeakMap(), _BrowserWindow_devicePixelRatio = new WeakMap(), _BrowserWindow_instances = new WeakSet(), _b = PropertySymbol.captureEventListenerCount, _c = PropertySymbol.mutationObservers, _d = PropertySymbol.readyStateManager, PropertySymbol.location, PropertySymbol.history, PropertySymbol.navigator, PropertySymbol.screen, PropertySymbol.sessionStorage, PropertySymbol.localStorage, PropertySymbol.setupVMContext)]() {
